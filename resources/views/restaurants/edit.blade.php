...
@section('content')
    ...
    <div class="container">
        <form method="POST" enctype="multipart/form-data" action="{{ route('restaurants.update', $restaurant->id) }}">
            @csrf
            @method('PATCH')
            <h2 class="mt-4">Modifica dati</h2>
            ...
            <div class="row">
                ...
                <div class="col-5 form-group my-3">
                    <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{$restaurant->image}}">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <input type="time" class="form-control @error('opening_time') is-invalid @enderror" name="opening_time"
                        id="opening_time" value="{{ ($restaurant->opening_time) }}">
                    @error('opening_time')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-2">
                    ...
                    <input type="time" class="form-control @error('closing_time') is-invalid @enderror" name="closing_time"
                        id="closing_time" value="{{ ($restaurant->closing_time) }}">
                    @error('closing_time')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
