        ...
        <div id="nav-bg">
            <nav class="navbar navbar-light d-flex justify-content-space-between container">
                ...
                <div>
                    ...
                    <a class="btn btn-light" href="{{ route('restaurants.create') }}" role="button">Accedi o
                        registrati</a>
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <hr>
                    <a class="btn btn-primary mx-3" href="{{ route('restaurants.create') }}" role="button">Accedi o
                        registrati</a>
