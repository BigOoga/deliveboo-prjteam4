        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12 d-flex py-3">
              <div class="card flex-grow-1 shadow-card" style="width: 18rem;">
          ...
          <div class="row row-cols-1 row-cols-md-3 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card image --}}
                  <img src="{{ asset('images/sushi.jpg')}}" class="card-img-top shadow-card" alt="Sushi" >
                    <div class="mt-2">
                      {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}}
                  <img src="{{ asset('images/pokè.jpg')}}" class="card-img-top shadow-card" alt="Pokè-bowl">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}}
                  <img src="{{ asset('images/tacos.jpg')}}" class="card-img-top shadow-card" alt="Cucina-Messico">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card image --}}
                  <img src="{{ asset('images/fastfood.jpg')}}" class="card-img-top shadow-card" alt="Fast-food">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card image  --}}
                  <img src="{{ asset('images/pizza.jpg')}}" class="card-img-top shadow-card" alt="Pizza">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}}
                  <img src="{{ asset('images/pasta.jpg')}}" class="card-img-top shadow-card" alt="Pasta">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}}
                  <img src="{{ asset('images/pesce.jpg')}}" class="card-img-top shadow-card" alt="Frittura-di-pesce">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}} 
                  <img src="{{ asset('images/kebab.jpg')}}" class="card-img-top shadow-card" alt="Kebab">
                  <div class="mt-2">
                    {{-- Card title --}}
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div>
                <a href="{{ route('restaurants.index') }}">
                  {{-- Card Image  --}}
                  <img src="{{ asset('images/vietnamita.jpg')}}" class="card-img-top shadow-card" alt="Cucina-Vietnam">
                  <div class="mt-2">
                    {{-- Card title --}}
        ...
        <div class="container">
          <h2 class="mb-4">Cerchi qualcos'altro?</h2>
            @foreach ($types as $type)
              <a href="{{ route('restaurants.index') }}" class="btn px-3">{{ $type->name }}</a>
            @endforeach
        </div>
      </section>
    </main>
